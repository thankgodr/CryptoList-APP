...
import com.richard.cryptolist.presentation.Screen
import com.richard.cryptolist.presentation.coin_detail.components.CoinTag
import com.richard.cryptolist.presentation.coin_detail.components.TeamListItem
            ...
            contentPadding = PaddingValues(20.dp)){
                item{
                    Row(
                        ...
                        Text(
                            text = if(coin.isAvtive) "active" else "inactive",
                            color = if(coin.isAvtive) Color.Green else Color.Red,
